...
@section('title') Admin - About Me Approval @endsection
...
@section('content')
  ...
  <div class="container pt-3">
    <h3 class="colorSecondary inATitle1">About Me Approval</h3>
                ...
                <div class="mb-3">
                    <div class="dropdown  d-inline float-end ms-2 me-2">
                        ...
                        <ul class="dropdown-menu inBorderColor1">
                            <li>
                                <a href="{{route('admin.aboutMeList',['filter' => 'all'])}}" name="filter" value="all" class="dropdown-item">All About Me<span class="badge text-bg-secondary ms-1">@if(isset($aboutmeCount)){{$aboutmeCount}}@endif</span></a>
                            </li>
                            <li>
                                <a href="{{route('admin.aboutMeList',['filter' => 'approved'])}}" name="filter" value="approved" class="dropdown-item">Approved<span class="badge text-bg-secondary ms-1">@if(isset($aboutmeApprovedCount)){{$aboutmeApprovedCount}}@endif</span></a>
                            </li>
                            <li>
                                <a href="{{route('admin.aboutMeList',['filter' => 'unapproved'])}}" name="filter" value="unapproved" class="dropdown-item">Unapproved<span class="badge text-bg-secondary ms-1">@if(isset($aboutmeUnapprovedCount)){{$aboutmeUnapprovedCount}}@endif</span></a>
                            </li>
                            <li>
                                <a href="{{route('admin.aboutMeList',['filter' => 'pending'])}}" name="filter" value="pending" class="dropdown-item">Pending<span class="badge text-bg-secondary ms-1">@if(isset($aboutmePendingCount)){{$aboutmePendingCount}}@endif</span></a>
                            </li>
                        </ul>
                    </div>
                </div>    
        ...
        <div class="col-12">
            <div class="card inBorderColor1">
                ...
                <div class="card-body inAddDetailTable table-responsive">
                    <form action="{{ route('admin.aboutMeStatus') }}" method="post" id="approveForm">
                        @csrf
                        @method('PATCH')
                        <table id="all_aboutme" class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if($data->profile_text_approve == "APPROVED")<i class="fas fa-thumbs-up"></i>@elseif($data->profile_text_approve == "UNAPPROVED")<i class="fas fa-thumbs-down pe-1"></i>@else <i class="fas fa-clock pe-1"></i> @endif</td>
                                    <td>
                                        <p>{{substr($data->profile_text,0,5)}}.&nbsp;<a href="" class="text-decoration-none font-14 colorPrimary" data-bs-toggle="modal" data-bs-target="#aboutModal{{$data->id}}">
                                            Read more
                                        </a></p>
                                    </td>
                                    <td>
                                        <a href="{{route('admin.aboutMeDelete',$data->id)}}" class="btn btnSecondary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                <div class="modal fade inAddDetailsModal" id="aboutModal{{$data->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="religionModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-12 mb-3 mt-2">
                                                        <p>@if(isset($data->profile_text)){{$data->profile_text}}@endif</p>
                                                    </div>  
                                                </div>   
                                            </div>
                                        </div>
