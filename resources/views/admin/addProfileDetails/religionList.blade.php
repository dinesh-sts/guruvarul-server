...
<!-- Page title -->
@section('title') Admin - All Religion @endsection
...
<div class="container pt-3">
    ...
    <h3 class="colorSecondary inATitle1">Religion</h3>
    ...
    <div class="inMemberTopPanel">
        <div class="pb-0">
            <div class="row">
                <div class="mb-3">
                    <a href="#" class="btn btnSecondary" data-bs-toggle="modal" data-bs-target="#religionModal">
                        <i class="fas fa-plus pe-1"></i>Add Religion
                    </a>
                    <div class="dropdown float-end ms-2 me-2">
                        ...
                        <ul class="dropdown-menu inBorderColor1">
                            <li>
                                <a href="{{ route('admin.religionList',['filter' => 'all']) }}" name="filter" value="all" class="dropdown-item">All Religion<span class="badge text-bg-secondary ms-1">{{$religionCount}}</span></a>
                            </li>
                            <li>
                                <a href="{{ route('admin.religionList',['filter' => 'approved']) }}" name="filter" value="approved" class="dropdown-item">Approved<span class="badge text-bg-secondary ms-1">{{ $religionApprovedCount }}</span></a>
                            </li>
                            <li>
                                <a href="{{ route('admin.religionList',['filter' => 'unapproved']) }}" name="filter" value="unapproved" class="dropdown-item">Unapproved<span class="badge text-bg-secondary ms-1">{{ $religionUnapprovedCount }}</span></a>
                            </li>
                        </ul>
                    </div>
                </div>    
        ...
        <div class="col-12">
            <div class="card inBorderColor1">
                ...
                <div class="card-body inAddDetailTable">
                    <form action="{{ route('admin.religionStatus') }}" method="post" id="approveForm">
                        @csrf
                        @method('PATCH')

                        <table id="all_religion" class="table table-resonsive">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="font-14">{{ $data->religion_name }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#" class="btn btnPrimary me-1" data-bs-toggle="modal" data-bs-target="#religionModal{{ $data->id }}" data-bs-title="Edit">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <a href="{{ route('admin.religionDelete',$data->id) }}" class="btn btnSecondary" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                <!-- Edit religion modal -->
                                <div class="modal fade inAddDetailsModal" id="religionModal{{ $data->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="religionModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form method="Post" action="{{ route('admin.religionStatus') }}">
                                                @csrf
                                                @method('PATCH')

                                                <div class="modal-header">
                                                    <h1 class="modal-title" id="religionModalLabel">Edit Religion</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12 mb-3 mt-2">
                                                            <label class="label-1 fw-semibold">Religion Name</label>
                                                            <input type="text" class="form-control" value="{{ $data->religion_name }}" name="religion_name" placeholder="Enter Religion Name" required>
                                                        </div>
...
<!-- Add religion modal -->
<div class="modal fade inAddDetailsModal" id="religionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="religionModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="Post" action="{{ route('admin.religionStore') }}">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title" id="religionModalLabel">Add Religion</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 mb-3 mt-2">
                            <label class="label-1 fw-semibold">Religion Name</label>
                            <input type="text" class="form-control" name="religion_name" placeholder="Enter Religion Name" required>
                        </div>
                        <div class="col-12 mb-3">
                            <div class="row">
                                <div class="col-xl-2 col-3">
