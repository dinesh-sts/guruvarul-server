...
<div class="container pt-3">
    <h3 class="colorSecondary inATitle1">Annual Income</h3>
            ...
            <div class="row">
                <div class="mb-3">
                    <a href="#" class="btn btnSecondary" data-bs-toggle="modal" data-bs-target="#incomeModal">
                        <i class="fas fa-plus pe-1"></i>Add Annual Income
                    </a>
                    <div class="dropdown float-end ms-2 me-2">
                        ...
                        <ul class="dropdown-menu inBorderColor1">
                            <li>
                                <a href="{{route('admin.incomeList',['filter' => 'all'])}}" name="filter" value="all" class="dropdown-item">All Annual Income<span class="badge text-bg-secondary ms-1">{{$incomeCount}}</span></a>
                            </li>
                            <li>
                                        ...
                                        <div class="modal-content">
                                            <form method="Post" action="{{route('admin.incomeStatus')}}">
                                                ...
                                                <div class="modal-header">
                                                    <h1 class="modal-title" id="religionModalLabel">Edit Annual Income</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12 mb-3 mt-2">
                                                            <label class="label-1 fw-semibold">Annual Income</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="Post" action="{{route('admin.incomeStore') }}">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title" id="religionModalLabel">Add Annual Income</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
