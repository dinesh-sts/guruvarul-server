...
<!-- Page title -->
@section('title') Admin - Profile Block Activity @endsection
...
<div class="container pt-3">
    ...
    <h3 class="colorSecondary inATitle1">Profile Block Activity</h3>
        ...
        <div class="col-12">
            <div class="card inBorderColor1">
                ...
                <div class="card-body inAddDetailTable table-responsive">
                    <form action="{{ route('admin.blockedActivityStatus') }}" method="post" id="approveForm">
                        @csrf
                        @method('PATCH')
                        <table id="all_blockedactivity" class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Member Id</th>
                            ...
                            <tbody>
                                @foreach ($blockedactivity as $data)
                                    <tr>
                                        ...
                                        <td class="font-13">@if(isset($data['data']->block_date)){{$data['data']->block_date}}@endif</td>
                                        <td>
                                            <a href="{{route('admin.blockedActivityDelete',$data['data']->id)}}" onclick="return confirm('Are you sure wantto Delete This?')" class="btn btnSecondary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
