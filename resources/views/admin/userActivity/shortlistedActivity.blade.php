...
<!-- Page title -->
@section('title') Admin - Profile Shortlist Activity @endsection
...
<div class="container pt-3">
    ...
    <h3 class="colorSecondary inATitle1">Profile Shortlist Activity</h3>
        ...
        <div class="col-12">
            <div class="card inBorderColor1">
                ...
                <div class="card-body inAddDetailTable table-responsive">
                    <form action="{{ route('admin.shortlistedActivityStatus') }}" method="post" id="approveForm">
                        @csrf
                        @method('PATCH')
                        <table id="all_shortlisted" class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Member Id</th>
                            ...
                            <tbody>
                                @foreach ($shortlistedactivity as $data)
                                    <tr>
                                        ...
                                        <td class="font-13">@if(isset($data['data']->add_date)){{$data['data']->add_date}}@endif</td>
                                        <td>
                                            <a href="{{route('admin.shortlistedActivityDelete',$data['data']->id)}}" onclick="return confirm('Are you sure?')" class="btn btnSecondary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
