...
<!-- Page title -->
@section('title') Admin - Ignored Profile Activity @endsection
...
<div class="container pt-3">
    ...
    <h3 class="colorSecondary inATitle1">Ignored Profile Activity</h3>
        ...
        <div class="col-12">
            <div class="card inBorderColor1">
                ...
                <div class="card-body inAddDetailTable table-responsive">
                    <form action="{{ route('admin.ignoredActivityStatus') }}" method="post" id="approveForm">
                        @csrf
                        @method('PATCH')
                        <table id="all_ignoredactivity" class="table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Ignore Member Id</th>
                                    <th>Ignore By</th>
                                    <th>Date</th>
                                    <th>Option</th>   
                                </tr>
                            ...
                            <tbody>
                                @foreach ($ignoredactivity as $data)
                                    <tr>
                                        ...
                                        <td class="font-13">@if(isset($data['data']->ignore_date)){{$data['data']->ignore_date}}@endif</td>
                                        <td>
                                            <a href="{{route('admin.ignoredActivityDelete',$data['data']->id)}}" onclick="return confirm('Are you sure?')" class="btn btnSecondary" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
