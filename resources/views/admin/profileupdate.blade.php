...
@section('title') Admin - Admin Profile Update @endsection
        ...
        <div class="col-xl-8 offset-xl-2 mb-3">
            <div class="card inBorderColor1 inAAddMembership mb-3">
                ...
                <div class="card-body ps-5 pe-5">
                    <form action="{{ route('admin.adminProfileUpdatePost') }}" method="POST" >
                        @csrf
                        <div class="row mb-3">
                            <div class="col-xl-12 mb-3">
                                <label class="label-1">Admin Username</label>
                                <input type="text" value="{{ $admin->uname }}" name="uname" class="form-control @error('uname') is-invalid @enderror" required>
                                @error('uname')
                        ...
                        <div class="row mb-3">
                            <div class="col-xl-12 mb-3">
                                <label class="label-1">Admin Email Id</label>
                                <input type="text" value="{{ $admin->email }}" name="email" class="form-control @error('email') is-invalid @enderror" required>
                                @error('email')
                                <div style="color:red">{{ $message }}</div>
                                @enderror
                            </div>
