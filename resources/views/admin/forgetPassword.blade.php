                    ...
                    <div class="col-xl-4 m-auto">
                        ...
                        <div class="card card-hover">
                            <div class="card-body pe-4 ps-4 pt-4">
                                <form action="{{route('admin.forgotAdminPasswordStore')}}" method="POST">
                                    @csrf
                                    <h4 class="text-center inALoginHeading font-public">Forgot Password</h4>
                                    <p class="text-center inALoginSubHeading">Enter admin email id to generate password</p>
                                    <div class="form-floating mb-4 mt-4">
                                        <input type="email" name="email" class="form-control" id="floatingInput" placeholder="name@example.com">
                                        <label for="floatingInput">Email address</label>
                                    </div>
        
                                    <div class="mb-4 col-12 mb-4">
                                        <input type="submit" value="SUBMIT" class="btn btnSecondary d-block w-100 font-public">
                                    </div>
                                    <div class="mb-4 col-12 text-center">
                                        <a href="{{ route('admin.login') }}" class="text-decoration-none colorSecondary"><i class="fas fa-arrow-left pe-1"></i> Back To Login</a>
                                    </div>
                                </form>
                            </div>
                        </div>
