                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 mb-3 chosen-style-1">
                                        ...
                                        <select name="edu_detail[1]" class="form-select chosen-select" data-placeholder="Choose" id="floatingSelect" >
                                            <option value="" selected>Select</option>
                                            @foreach($edu_details as $edu_detail)
                                            <option value="{{$edu_detail->id}}"  @if(isset($register->edu_detail)) @if($get_edu_add[1] != "") {{$edu_detail->id == $get_edu_add[1] ? "selected" : ''}}@else @selected(old('edu_detail') == $edu_detail->id)@endif @endif>{{$edu_detail->edu_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @endif
