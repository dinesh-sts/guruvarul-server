    ...
    <div class="container mt-minus-220">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-5 pe-4 ps-4">
                        ...
                        @if($hasValidPayment)
                            {{-- Show full details --}}
                            @if(
                                ($register->photo1 != null || $register->photo2 != null || $register->photo3 != null || 
                                $register->photo4 != null || $register->photo5 != null || $register->photo6 != null || 
                                $register->photo7 != null || $register->photo8 != null) && 
                                (($register->photo_setting == '0') || 
                                ($register->photo_setting == '1' && Auth::guard('user')->user()->status == 'Paid') || 
                                ($register->photo_setting == '2' && $status->receiver_response == "Accept"))
                            )
                                <a href="#" class="btn btnPrimary d-block mb-4" data-bs-toggle="modal" data-bs-target="#memberProfilePhotos">
                                    View All Photos
                                </a>
                            @endif
                        @else
                            ...
                            <div class="alert alert-warning text-center mb-4">
                                Please upgrade to view full details and photos.
                            </div>
			    <a href="{{route('user.userMembershipPlans')}}" class="btn btnPrimary d-block w-100">Click here to upgrade your plan.</a>
                        @endif
            ...
            <div class="col-lg-12 col-md-12 mt-4">
                ...
                <div class="card inBorderColor1 mb-4 inMemberDetCard">
                    ...
                    <div class="card-body">
                        <div class="row">
                           ...
                           <div class="col-xl-6 col-lg-6 inMemTopBasicDet">
                                <h5 class=""><span class="inMemDetMain pe-1">Gender :</span><span class="ps-1 inMemDet">@if(isset($register->gender)){{$register->gender}}@else Not Available @endif</span></h5>
                            </div>
                            <div class="col-xl-6 col-lg-6 inMemTopBasicDet">
                                 <h5 class=""><span class="inMemDetMain pe-1">DOB :</span><span class="ps-1 inMemDet">@if(isset($register->birthdate)){{ \Carbon\Carbon::parse($register->birthdate)->format('d-m-Y') }}@else Not Available @endif</span></h5>
                            </div>
                             <div class="col-xl-6 col-lg-6 inMemTopBasicDet">
                ...
                <div class="card inBorderColor1 mb-4 inMemberDetCard">
                    <div class="card-header">
                        <h5><i class="fas fa-book pe-2"></i>Horoscope Details</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row inMB-5">
                            ...
                            <div class="col-xl-12 inMemTopBasicDet">
                                <div class="row">
                                    ...
                                    @endif
                                    <div class="col-5">
                                        <h5 class="inMemDetMain">Monthly Income</h5>
                                    </div>
                                    <div class="col">
