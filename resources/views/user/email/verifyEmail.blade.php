																...
																<tr>
																	<td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                        ...
                                                                        @if($site_setting->web_logo_path != null)
                                                                            <img align="center" border="0" src="{{asset('storage/siteConfig/'.$site_setting->web_logo_path)}}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 32%;max-width: 179.2px;" width="179.2"/>
                                                                        @endif
                                                                    </td>
																</tr>
															</table>
														...
														<tr>
															<td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
																<div style="color: #e5eaf5; line-height: 140%; text-align: center; word-wrap: break-word;">
																	<p style="font-size: 14px; line-height: 140%;"><strong>T H A N K&nbsp; &nbsp; Y O U&nbsp; &nbsp;F O R&nbsp; &nbsp;R E G I S T E R&nbsp; &nbsp;!</strong></p>
																</div>
															</td>
														</tr>
													</tbody>
													...
													<table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
														<tbody>
															<tr>
																...
																<p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">You are registerd with your @if(isset($site_setting->web_name)){{$site_setting->web_name}}@endif,Please verify your email id. </span></p>
																</div>
																...
																<td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
																	<div align="center">
                                                                        @if(Auth::guard('user')->user())
                                                                            <a href="{{ route('user.login.varification', $token) }}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff6600; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                        ...
                                                                        @else
                                                                            <a href="{{ route('user.emailVerification', $token) }}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff6600; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                                <span style="display:block;padding:14px 44px 13px;line-height:120%;"><span style="font-size: 16px; line-height: 19.2px;"><strong><span style="line-height: 19.2px; font-size: 16px;">VERIFY YOUR EMAIL</span></strong></span></span>
                                                                            </a>
                                                                        @endif
																	...
																	<div align="center">
                                                                        @if(Auth::guard('user')->user())
                                                                        <h4>Incase you can not verify email id by clicking on button please copy and paste this link in url.<a href="{{ route('user.login.varification', $token) }}" style="font-family: Roboto, sans-serif;"><br>{{ route('user.login.varification', $token) }}</a></h4>
                                                                    @else
                                                                        <h4>Incase you can not verify email id by clicking on button please copy and paste this link in url.<a href="{{ route('user.emailVerification', $token) }}" style="font-family: Roboto, sans-serif;"><br> {{ route('user.emailVerification', $token) }}</a></h4>
                                                                    @endif
