...
<section class="inMemberProfile">
            ...
            <div class="col-xl-10 offset-xl-1">
			    ...
			    // Check payment & expiry date
                            ...
                            if ($payment && !empty($payment->exp_date)) {
                                try {
                                    // Parse the date in d-m-y format (two-digit year)
                                    $expDate = DateTime::createFromFormat('d-m-y', $payment->exp_date);
                        ...
                        @endif
			@if($register->hor_photo != null)
                        <a href="#" class="btn btnPrimary d-block mb-4" data-bs-toggle="modal" data-bs-target="#memberProfileHoro">View Horoscope</a>
                        @endif
		            ...
		            @php
                        ...
                        if ($latestPayment && $latestPayment->exp_date) {
                            ...
                            $expiryFullYear = \Carbon\Carbon::createFromFormat('d-m-y', $latestPayment->exp_date)->format('d-m-Y');
                        }
                    @endphp
				    ...
				    @if($profileviewsetting->username_setting == "full_username")
				        <h5 class="">
				            @if(!empty($register->firstname)) {{ $register->firstname }} @endif
				            @if(!empty($register->lastname)) {{ $register->lastname }} @endif
				        </h5>
				    @elseif($profileviewsetting->username_setting == "first_surname")
				        <h5 class="">
				            @if(!empty($register->firstname)) {{ $register->firstname }} @endif
				            @if(!empty($register->lastname)) {{ substr($register->lastname, 0, 1) }}. @endif
				        </h5>
				    @else
				        <h5 class="">
				            @if(!empty($register->matri_id)) {{ $register->matri_id }} @endif
				        </h5>
				    @endif
				    ...
				    <h6 class="mb-3">
				        ...
				        &nbsp;&nbsp;|&nbsp;&nbsp; 
				        Profile Created by 
				        @if(!empty($register->profilecreatedby)) {{ $register->profilecreatedby }} @endif
				    </h6>
				</div>
			    ...
			    <div class="row">
                                <div class="col-lg-6 col-xl-6 inMemTopBasicDet">
                                    <h5 class=""><span class="inMemDetMain pe-1">MemberShip Expiry </span><span class="ps-1 inMemDet"><strong>@if(isset($expiryFullYear)) {{$expiryFullYear}}@else N/A @endif</strong></span></h5>
                                </div>
				<div class="col-lg-6 col-xl-5 inMemTopBasicDet">
                                    <h5 class=""><span class="inMemDetMain pe-1">DOB </span><span class="ps-1 inMemDet">{{$register->birthdate}}</span></h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-xl-6 inMemTopBasicDet">
                ...
                <div class="card inBorderColor1 mb-4 inMemberDetCard">
                    ...
                    <div class="card-body">
                        <div class="row inMB-5">
                            ...
                            <div class="col-xl-6 col-lg-6 inMemTopBasicDet">
                                <h5 class=""><span class="inMemDetMain pe-1">Monthly Income :</span><span class="ps-1 inMemDet">@if(isset($register->income)){{$register->inc->income}}@else Not Available @endif</span></h5>
                            </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="card inBorderColor1 mb-4 inMemberDetCard">
                    ...
                    <div class="card-body">
                        <div class="row inMB-5">
                            ...
                            <div class="col-xl-6 col-lg-6 inMemTopBasicDet">
                                <h5 class=""><span class="inMemDetMain pe-1">City :</span><span class="ps-1 inMemDet">@if(isset($register->city) && isset($register->citi->city_name)){{$register->citi->city_name}}@else Not Available @endif</span></h5>
                            </div>
    ...
    @endif 
     ...
     <!-- Member photo Modal -->
		<div class="modal fade" id="memberProfileHoro" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="memberProfileHoroLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
					<h5 class="modal-title" id="memberProfileHoroLabel">Horoscope of {{$register->matri_id}}</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<div class="row">
					...
					@if($register->hor_photo != "" && $register->hor_check == "APPROVED" && Storage::disk('public')->exists($filePath))
                            <a href="{{ asset('storage/userImages/'.$register->hor_photo) }}" 
