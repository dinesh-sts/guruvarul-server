...
<section class="inPageHeader">
    <div class="container">
        <h2 class="text-center">Contact Privacy</h2>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="card mb-4 inBorderColor1">
                    <div class="card-body">
                        <form action="{{route('user.contactPrivacyStore')}}" method="Post">
                            @csrf
                            <div class="row inPrivacyCurrentStatus">
                                ...
                                <div class="col-xl-6 pt-2">
                                    <h4 class="inPrivacyStatus"><i class="fas fa-eye pe-2"></i>@if(isset($contactprivacy->contact_view_security))@if($contactprivacy->contact_view_security == '1')Show To Paid Members @else Show To Express Interest Accepted & Paid Members @endif @endif</h4>
                                </div>
                            ...
                            <div class="collapse mt-4" id="collapseExample2">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 mb-3">
                                        <label>
                                            <input type="radio" value="1" @if(isset($contactprivacy->contact_view_security)){{$contactprivacy->contact_view_security == '1' ? 'checked' : ''}}@endif name="contact_view_security" >
                                            <span class="ps-2">Show To All Paid Members</span>
                                        </label>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 mb-3">
                                        <label>
                                            <input type="radio" value="0"  @if(isset($contactprivacy->contact_view_security)){{$contactprivacy->contact_view_security == '0' ? 'checked' : ''}}@endif name="contact_view_security" class="pe-2">
                                            <span class="ps-2">Show To Express Interest Accepted & Paid Members</span>
                                        </label>
                                    </div>
