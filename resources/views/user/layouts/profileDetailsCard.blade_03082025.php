        ...
        <div class="col-lg-8">
            <div class="card-body">
               <a href="{{ route('user.memberProfile',$data->matri_id) }}" title="{{$data->matri_id}}" class="text-decoration-none">
                    ...
                    <p class="card-text">@if(isset($data->occupation)){{$data->occ->ocp_name}}@else Not Available @endif, @if(isset($data->h_edu->edu_name)){{$data->h_edu->edu_name}}@else Not Available @endif, @if(isset($data->city)){{$data->citi->city_name}}@else Not Available @endif, @if(isset($data->country)){{$data->country->country_name}}@else Not Available @endif</p>
                </a>
