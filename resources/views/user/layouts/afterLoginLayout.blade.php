...
<html lang="en">
    ...
    <body class="bg1">
	<!-- ✅ Custom Install Banner HTML -->
	<div id="installBanner" style="display:none;position:fixed;bottom:0;left:0;right:0;background:#ff6600;color:white;padding:15px;text-align:center;box-shadow:0 -2px 5px rgba(0,0,0,0.3);z-index:9999;">
	    <span style="font-size:16px;font-weight:bold;">Install Guruvarul App</span>
	    <button id="installAppBtn" style="margin-left:15px;padding:8px 15px;background:white;color:#ff6600;font-weight:bold;border:none;border-radius:8px;cursor:pointer;">
	      Install
	    </button>
	    <button id="closeBannerBtn" style="margin-left:10px;padding:8px 15px;background:transparent;color:white;border:1px solid white;border-radius:8px;cursor:pointer;">
	      Later
	    </button>
	</div>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                            ...
                            <div class="offcanvas-body justify-content-end">
                                ...
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item">
                                        <!-- <a class="nav-link" href="{{route('user.searchUser')}}"><i class="fas fa-magnifying-glass"></i>PROFILES</a> -->
                                        <a class="nav-link" href="{{route('user.searchResultView')}}">
						...
						PROFILES
                                    ...
                                    <!-- /.Visible Only In Small Screen -->
                                     <li class="nav-item d-block d-lg-none">
                                        <a class="nav-link" href="{{ route('user.deleteProfile') }}">MARRIAGE FIXED</a>
                                    </li>
                                    <li class="nav-item d-block d-lg-none">
                                ...
                                <ul class="justify-content-end navbar-nav me-auto mb-2 mb-lg-0 ">
                                    ...
                                    <li class="nav-item d-block d-none d-lg-block">
                                        <a class="nav-link" href="{{ route('user.deleteProfile') }}">MARRIAGE FIXED</a>
                                    </li>
                                    <li class="nav-item d-block d-none d-lg-block">
                                        <a class="nav-link" href="{{ route('user.logout') }}">LOGOUT</a>
	...
	let deferredPrompt;
	    ...
	    function shouldShowBanner() {
	        ...
	        const now = new Date();
	        return now.toDateString() !== lastDate.toDateString(); // once per day
	    }
	    ...
	    window.addEventListener('beforeinstallprompt', (e) => {
	        ...
	        if (shouldShowBanner()) {
	            ...
	            localStorage.setItem("installBannerLastShown", new Date());
	        }
	    });
