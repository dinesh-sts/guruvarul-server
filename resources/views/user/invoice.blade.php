...
<div class="container pt-3 inInvoice">
    <div class="row">
        ...
        <div class="card mb-4 shadow inBorderColor1" id="printableArea">
            <div class="card-body p-4">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-4 inInvoiceCustDet mb-4">
                        ...
                        <h5><span>Contact No</span>: @if(isset($payment->pcontact)){{$payment->pcontact}}@endif</h5>
                        <h5><span>Email id</span>: @if(isset($payment->pemail)){{$payment->pemail}}@endif</h5>
                    </div>
                    <div class="col-4 inInvoiceCustDet mb-4">
                    ...
                    <div class="col-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>@if(isset($payment->p_plan)){{$payment->p_plan}}@endif for @if(isset($payment->plan_duration)){{$payment->plan_duration}}@endif Days</td>
