                        ...
                        <div class="card">
                            <div class="card-body p-md-5 p-4">
                                <form id="Quicksearch">
                                    ...
                                    <div class="mb-4 row chosen-style-3">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Caste</label>
                                        <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-body p-md-5 p-4">
                                <form id="advancesearch">
                                    ...
                                    @endif
                                    <div class="mb-4 row chosen-style-3">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Marital Status</label>
                                        <div class="col-sm-6">
                                            <select name="m_status[]" class="form-select chosen-select" id="floatingSelect" data-placeholder="Select" multiple>
                                    ...
                                    <div class="mb-4 row chosen-style-3">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Caste</label>
                                        <div class="col-sm-6">
                                            <select name="part_caste[]" class="form-select chosen-select" id="part_caste_as" data-placeholder="Select" multiple>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-4 row">
                                    ...
                                    <div class="mb-4 row chosen-style-3">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="part_state[]" id="part_state" class="form-select chosen-select" data-placeholder="Select" multiple>                            
                                            </select>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="mb-4 row chosen-style-3">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="part_city[]" class="form-select chosen-select" id="part_city" data-placeholder="Choose" multiple>
                                            </select>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="mb-4 row chosen-style-3">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Education</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="mb-4 row chosen-style-3">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Occupation</label>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="mb-4 row chosen-style-3">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Monthly Income</label>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="mb-4 row chosen-style-3">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="part_edu[]" class="form-select chosen-select" data-placeholder="Select" multiple>
                                                    <option value="">Select</option>
                                                    @foreach($edu_details as $eduDetail)
                        ...
                        <div class="card">
                            <div class="card-body p-md-5 p-4">
                                <form id="Memberidsearch">
                                    <div class="mb-4 row">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Member Id</label>
                                        <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-body card-body p-md-5 p-4 ">
                                <form id="keywordsearch">
                                    <div class="mb-4 row">
                                        <label for="inputPassword" class="col-sm-3 col-form-label">Enter Keyword</label>
                                        <div class="col-sm-6">
