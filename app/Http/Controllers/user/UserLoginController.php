...
class UserLoginController extends Controller
{
    ...
    public function regenerateOtp(Request $request)
    {
        ...
        if($user != ""){
            ...
            //dd($api);
            if($api === null) {
            return redirect()->back()->with('message','Something went wrong, Please try again few mins later!');
            }
	...
	return redirect()->route('user.loginWithOtp')->with('message', 'Logout securely.');
    }
